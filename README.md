# Camunda Spring Boot Stater + Example Twitter
Project Base: Camunda Spring Boot Stater v7.17 https://start.camunda.com/

Example Twitter: https://github.com/camunda/camunda-bpm-examples/tree/7.17/spring-boot-starter/example-twitter

*Note:* Example Twitter Project can't run h2 database. So, we move all source form Example Twitter to
Project Base: Camunda Spring Boot Stater v7.17 that generate from https://start.camunda.com/
